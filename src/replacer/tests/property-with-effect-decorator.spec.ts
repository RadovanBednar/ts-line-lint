...
export function propertyWithEffectDecoratorRuleTestSuite(): void {
    ...
    describe('has option "remove: none"', () => {
        ...
        beforeEach(() => {
            config = createMockConfig('property-with-effect-decorator', 'remove', 'none');
        });
    ...
    describe('has option "remove: before"', () => {
        ...
        beforeEach(() => {
            config = createMockConfig('property-with-effect-decorator', 'remove', 'before');
        });

        it('should remove blank lines before each property with @Effect decorator', () => {
    ...
    describe('has option "remove: after"', () => {
        ...
        beforeEach(() => {
            config = createMockConfig('property-with-effect-decorator', 'remove', 'after');
        });

        it('should remove blank lines after each property with @Effect decorator', () => {
    ...
    describe('has option "remove: both"', () => {
        ...
        beforeEach(() => {
            config = createMockConfig('property-with-effect-decorator', 'remove', 'both');
        });

        it('should remove blank lines both before and after each property with @Effect decorator', () => {
    ...
    describe('has option "insert: none"', () => {
        ...
        beforeEach(() => {
            config = createMockConfig('property-with-effect-decorator', 'insert', 'none');
        });
    ...
    describe('has option "insert: before"', () => {
        ...
        beforeEach(() => {
            config = createMockConfig('property-with-effect-decorator', 'insert', 'before');
        });

        it('should insert a blank line before each property with @Effect decorator', () => {
    ...
    describe('has option "insert: after"', () => {
        ...
        beforeEach(() => {
            config = createMockConfig('property-with-effect-decorator', 'insert', 'after');
        });

        it('should insert a blank line after each property with @Effect decorator', () => {
    ...
    describe('has option "insert: both"', () => {
        ...
        beforeEach(() => {
            config = createMockConfig('property-with-effect-decorator', 'insert', 'both');
        });

        it('should insert blank lines both before and after each property with @Effect decorator', () => {
    ...
    describe('has both "remove" and "insert" options', () => {
        ...
        beforeEach(() => {
            config = {
                ...EMPTY_RULES_CONFIG,
                rules: { 'property-with-effect-decorator': { remove: 'both', insert: 'after' } },
            };
        });
