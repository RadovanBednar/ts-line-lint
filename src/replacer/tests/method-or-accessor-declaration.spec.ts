...
export function methodOrAccessorDeclarationRuleTestSuite(): void {
    ...
    describe('has option "remove: before"', () => {
        ...
        it('should remove blank lines before each method or accessor declaration', () => {
    ...
    describe('has option "remove: after"', () => {
        ...
        it('should remove blank lines after each method or accessor declaration', () => {
    ...
    describe('has option "remove: both"', () => {
        ...
        it('should remove blank lines both before and after each method or accessor declaration', () => {
    ...
    describe('has option "insert: before"', () => {
        ...
        it('should insert a blank line before each method or accessor declaration', () => {
    ...
    describe('has option "insert: after"', () => {
        ...
        it('should insert a blank line after each method or accessor declaration', () => {
    ...
    describe('has option "insert: both"', () => {
        ...
        it('should insert blank lines both before and after each method or accessor declaration', () => {
