...
export function unitTestItStatementRuleTestSuite(): void {
    ...
    describe('has option "remove: none"', () => {
        ...
        beforeEach(() => {
            config = createMockConfig('unit-test-it-statement', 'remove', 'none');
        });
    ...
    describe('has option "remove: before"', () => {
        ...
        beforeEach(() => {
            config = createMockConfig('unit-test-it-statement', 'remove', 'before');
        });

        it('should remove blank lines before each it statement', () => {
    ...
    describe('has option "remove: after"', () => {
        ...
        beforeEach(() => {
            config = createMockConfig('unit-test-it-statement', 'remove', 'after');
        });

        it('should remove blank lines after each it statement', () => {
    ...
    describe('has option "remove: both"', () => {
        ...
        beforeEach(() => {
            config = createMockConfig('unit-test-it-statement', 'remove', 'both');
        });

        it('should remove blank lines both before and after each it statement', () => {
    ...
    describe('has option "insert: none"', () => {
        ...
        beforeEach(() => {
            config = createMockConfig('unit-test-it-statement', 'insert', 'none');
        });
    ...
    describe('has option "insert: before"', () => {
        ...
        beforeEach(() => {
            config = createMockConfig('unit-test-it-statement', 'insert', 'before');
        });

        it('should insert a blank line before each it statement', () => {
    ...
    describe('has option "insert: after"', () => {
        ...
        beforeEach(() => {
            config = createMockConfig('unit-test-it-statement', 'insert', 'after');
        });

        it('should insert a blank line after each it statement', () => {
    ...
    describe('has option "insert: both"', () => {
        ...
        beforeEach(() => {
            config = createMockConfig('unit-test-it-statement', 'insert', 'both');
        });

        it('should insert blank lines both before and after each it statement', () => {
    ...
    describe('has both "remove" and "insert" options', () => {
        ...
        beforeEach(() => {
            config = {
                ...EMPTY_RULES_CONFIG,
                rules: { 'unit-test-it-statement': { remove: 'both', insert: 'after' } },
            };
        });
